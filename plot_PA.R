...
#
# Last modified 22 April 2020 by Rob Nicholas <rob.nicholas@gmail.com>.
...
plot(dtd_aggregate_cases[-(1:40)], xlab="days since 3/1/2020", ylab="new cases", main="COVID-19 in Pennsylvania")
x11()
plot(dtd_aggregate_deaths[-(1:40)], xlab="days since 3/1/2020", ylab="deaths", main="COVID-19 in Pennsylvania")
...
x11()
plot(dtd_locality_cases[-(1:40)], xlab="days since 3/1/2020", ylab="new cases", main="COVID-19 in Centre County")
x11()
plot(dtd_locality_deaths[-(1:40)], xlab="days since 3/1/2020", ylab="deaths", main="COVID-19 in Centre County")
